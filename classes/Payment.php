...
class Payment extends AbstractPayment {
    ...
    public function getOfflinePaymentOption()
    {
        ...
        $offlineOption->setCallToActionText($this->trans('Pay offline', [], 'Modules.Paymentexample.Payment'))
                      ->setAction($this->module->context->link->getModuleLink($this->module->name, 'validation', [], true))
                      ->setAdditionalInformation($this->module->context->smarty->fetch('module:paymentexample/views/templates/front/payment_infos.tpl'))
